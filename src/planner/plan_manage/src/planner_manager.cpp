...
namespace ego_planner
{
                                        ...
                                        Eigen::Vector3d local_target_vel, bool flag_polyInit, bool flag_randomPolyTraj)
  {
    ...
    do
    {
      ...
      else // Initial path generated from previous trajectory.
      {
        ...
        // 利用之前生成的轨迹，用 segment_point 存储从当前时刻开始以 ts 为步长的点集（每一段的首尾两点）
        // pseudo_arc_length 累积存储每一段的段长
        double t;
        ...
        // 这个是为了防止之前生成的轨迹没有到达 local_target_pt 的
        ...
        do
        {
          // 每次重新开始都是因为上一轮采样点个数太少了，所以会将采样点之间的距离缩小 1.5 倍。
          cps_dist /= 1.5;
          point_set.clear();
          sample_length = 0;
          id = 0;
          ...
          {
            // 保证采样点在 pseudo_arc_length[id] 与 pseudo_arc_length[id + 1] 之间，且两个采样点之间的距离至少为 cps_dist
  ...
  // 原本我以为对 B 样条曲线重新参数化会很麻烦，结果没想到只要在原 B 样条曲线上按照新的时间间隔采样就可以了，可见 B 样条曲线的优越特性
